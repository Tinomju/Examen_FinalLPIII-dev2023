<page backtop="10mm" backbottom="10mm" backleft="20mm" backright="20mm">
    ...
    <table style="width: 70%;border: solid 1px #5544DD; border-collapse: collapse" align="center">
        <thead>
            <tr>
                <th style="width: 15%; text-align: left; border: solid 1px #900C3F; background: #900C3F; color: #FFFFFF;"><span style="color: #FFFFFF;">NRO.</span></th>
                <th style="width: 25%; text-align: left; border: solid 1px #900C3F; background: #900C3F; color: #FFFFFF;"><span style="color: #FFFFFF;">DESCRIPCION</span></th>
                <th style="width: 30%; text-align: left; border: solid 1px #900C3F; background: #900C3F; color: #FFFFFF;"><span style="color: #FFFFFF;">ID</span></th>
            </tr>
        </thead>
        <tbody>
                <?php
